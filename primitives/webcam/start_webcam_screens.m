function arrwcs = start_webcam_screens(mainwnd, arrwcs, varargin)
    ...
    for w=1:arrwcs.num
        ...
        Screen('StartVideoCapture', arrwcs.wcs(w).grabber, arrwcs.settings.fps, drop_frames);
    end
