%% showMovieFromVideoAudioDatAtFrameTrigger(file_video, file_audio, win, audio_frame, ao, lpt, trigger_start, trigger_sound, trigger_end, varargin)
% functions:
...
%%
function showMovieFromVideoAudioAtFrameTrigger(file_video, file_audio, win, audio_frame, ao, lpt, trigger_start, trigger_sound, trigger_end, varargin)
